...
literature related to software tools
%Left out a ref which could cause problems
...
present a small set of recommendations which we hope will lead to
...
the Recomputation
Manifesto~\footnote{\url{http://www.recomputation.org/}}, as well as
...
license; BSD and Apache are good, flexible ones.%, though IANAL.  
A wide
